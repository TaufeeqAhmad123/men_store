...
import 'package:men_store/description/descriptionScreen.dart';
import 'package:men_store/model/category_model.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          _titleText(),
          _searchBar(),
          _rowWidget('New Arrival'),
          _newArival(),
          SizedBox(height: Dimens.verticalBlockSize * 2),
          _rowWidget('Categories'),
          _category(),
        ],
      ),
    );
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: Image.asset(category.img, scale: 4.5),
                  ),
          ...
          children: List.generate(MainController.to.newArrival.length, (i) {
            return Enterylistitem(
              ...
              child: GestureDetector(
                onTap: () => Get.to(() => Descriptionscreen(immg: MainController.to.newArrival[i],)),
                child: Container(
                  margin: EdgeInsets.only(right: Dimens.s_15()),
                  height: Dimens.verticalBlockSize * 30,
                  width: Dimens.verticalBlockSize * 25,
