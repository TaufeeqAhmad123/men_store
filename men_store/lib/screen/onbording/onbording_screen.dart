...
import 'package:men_store/model/entry_model.dart';
import 'package:men_store/screen/home/homescreen.dart';
...
import 'package:men_store/utils/const/font_family.dart';
        ...
        children: List.generate(3, (i) {
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              color: _currentPage.value == i ? AppColors.orange : Colors.white,
            ),
          );
        }),
      ),
          ...
          child: Bounceable(
            ...
            child: Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    _currentPage.value==2 ? 'Get Started' : "Next",
